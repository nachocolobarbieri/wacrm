...
export interface Contact {
  ...
  account_id: string;
  /**
   * Nullable since migration 040 — a contact whose only identity is
   * Instagram/Facebook (via `contact_identities`) has no phone number.
   * Every WhatsApp/Meta-direct contact still always has one.
   */
  phone: string | null;
...
export interface Conversation {
  ...
  /**
   * Multi-channel routing (migration 040/041). `channel` defaults to
   * 'whatsapp' and `provider` to 'meta' for every conversation that
